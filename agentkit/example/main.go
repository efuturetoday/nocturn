...
var _ gate.Approver = (*consoleApprover)(nil)

func (c *consoleApprover) Ask(_ context.Context, a gate.Action, ceiling gate.Recall, suggest []gate.Grant) (bool, gate.Grant, gate.Recall, error) {
	...
	for _, s := range suggest { // widenings proposed by the tool
