...
// custom) wraps it trivially. kv are alternating key/value pairs (like slog). WithContext derives a
// logger enriched from ctx (request/trace ids) for request-scoped logging.
