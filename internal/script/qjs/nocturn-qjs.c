 ...
 * HITL). A pure-compute script never calls the gate and performs no effect.
 *
...
/* nocturn.call(tool, args) — dispatch an effect through the host gate. An
 * "error: ..." response (a denied/failed effect) becomes a thrown JS error the
