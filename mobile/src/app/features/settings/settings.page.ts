  ...
  template: `
    ...
    <ion-toolbar class="tabs">
      ...
      <ion-segment scrollable="true" value="general">
        ...
        <ion-segment-button value="permissions" contentId="permissions"><ion-label>Permissions</ion-label></ion-segment-button>
    ...
    <ion-segment-view>
      ...
      <ion-segment-content id="permissions"><app-permissions /></ion-segment-content>
