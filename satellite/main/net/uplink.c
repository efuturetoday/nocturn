...
// Bytes actually handed to the socket, and sends the link refused. Without these, a silent far side
// is indistinguishable from a board that never sent anything.
static volatile uint32_t sent_bytes;
static volatile uint32_t send_fails;
