...
func Serve(ctx context.Context, addr string, space *workspace.Workspace, devices *auth.Store, log *slog.Logger) error {
	...
	mux.HandleFunc("/ws", func(w http.ResponseWriter, r *http.Request) {
		...
		defer ws.CloseNow()
		newConn(ws, space, devices, log.With("remote", r.RemoteAddr)).serve(r.Context())
	})
